...
const collection_name = 'subProcess';
let mydb;
        ...
        try {
            const crieteria = [
                ...
                },
                {
                    $project: {
                        process_Details: 0,
                        'process.created_at': 0,
                        'process.modified_At': 0,
                        'process.created_by': 0,
                    }
                }
            ];
